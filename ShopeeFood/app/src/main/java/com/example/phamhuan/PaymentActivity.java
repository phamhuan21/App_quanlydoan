...
import com.example.phamhuan.ModelClass.Order;
import com.example.phamhuan.ModelClass.Payment;
...
public class PaymentActivity extends AppCompatActivity {
    ...
    public static void placeOrder(final Context ctx){
        ...
        for (Cart cart : Utils.cartList) {
            final Order order = new Order(cart.getName(), cart.getImage(), cart.getPrice(), cart.getQuantity(), cart.getKitchen(), Utils.Address, "Đang chờ","Đã thanh toán");
        ...
        Utils.showToast(ctx, "Đã đặt hàng thành công!");
        ((Activity) ctx).finish();
    }
