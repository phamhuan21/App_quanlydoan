...
import com.example.phamhuan.CartList;
...
public class CartFragment extends Fragment {
        ...
        placeorder.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(!Name.getText().toString().equals("")&&!Phone.getText().toString().equals("")&&!address.getText().toString().equals("")){
                    ...
                    Utils.showToast(ctx,"Vui lòng điền địa chỉ nhận hàng.");
                }
            }
        });
        return view;
    ...
    private static class RecyclerAdapter extends RecyclerView.Adapter<RecyclerAdapter.ViewHolder> {
        ...
        public void onBindViewHolder(@NonNull final ViewHolder holder, final int position) {
            ...
            holder.CartTotal.setText("Tổng cộng " + String.valueOf(cart.getPrice()*cart.getQuantity()) + "₫");
        }
        @Override
    ...
    private void setupPayment(){
        ...
        cod.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Utils.showToast(ctx, "Đơn hàng đã đặt thành công!");
                CartList.clearAll(ctx);
                maincart.setVisibility(View.GONE);
                nocart.setVisibility(View.VISIBLE);
            }
