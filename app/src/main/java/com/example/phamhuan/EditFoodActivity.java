...
public class EditFoodActivity extends AppCompatActivity {
    ...
    private String key;
    private Boolean CHECK_IMAGE = Boolean.FALSE;
    private String Names,Prices,Images,Restaurant;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Glide.with(EditFoodActivity.this).load(Images).into(imageView);
    ...
    public void onBackPressed() {
        EditFoodActivity.super.onBackPressed();
        Intent intent = new Intent(EditFoodActivity.this,FoodlistActivity.class);
    ...
    private void AddNewFood() {
        ...
        if(name.equals(Names) && price.equals(Prices)){
    ...
    private void addtodatabase() {
        ...
        if(image_uri != null && !image_uri.equals(Uri.EMPTY) ) {
                        ...
                        if (taskSnapshot.getMetadata().getReference() != null) {
                            ...
                            result.addOnSuccessListener(new OnSuccessListener<Uri>() {
                                ...
                                public void onSuccess(Uri uri) {
                                    ...
                                    reference.child(String.valueOf(key)).updateChildren(cartMap)
                                            .addOnSuccessListener(new OnSuccessListener<Void>() {
                                                @Override
                                                public void onSuccess(Void unused) {
                                                    progressDialog.dismiss();
                                                    Toast.makeText(EditFoodActivity.this, "Success!", Toast.LENGTH_SHORT).show();
            ...
            if (CHECK_IMAGE == Boolean.TRUE) {
                progressDialog.dismiss();
                Toast.makeText(EditFoodActivity.this, "Không có gì thay đổi...", Toast.LENGTH_SHORT).show();
            } else {
